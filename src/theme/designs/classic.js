 ...
 * - Shape: Sharp (borderRadius 8)
 * - Bubble strokes: lineWidth 3 / highlight 4
 * - Bubble fills: tag colors + '15'/'20' hex, or rgba blue/white
 */
...
export const classic = (mode) => {
  ...
  // Classic MUI default shadows (before soft shadows refactor)
  const buildClassicShadows = () => {
    const shadows = [
      'none',
